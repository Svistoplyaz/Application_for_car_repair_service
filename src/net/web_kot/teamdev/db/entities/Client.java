...
public class Client extends AbstractEntity {
    ...
    public void save() throws Exception {
        if(id == -1)
            id = model.db().insert("INSERT INTO Clients (Name, Phone) VALUES (%s, %s)", name, phone);
        else
            model.db().update("UPDATE Clients SET Name = %s, Phone = %s WHERE PK_Clients = %d", name, phone, id);
    }
